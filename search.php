<html>
    ...
    <body>
        ...
        $con= new mysqli("localhost","root","Pranav.vyas@1297","task");
                ...
                $sql= "SELECT * from naruto where title like '%".$a."%' ";
            ...
            echo "<input type='checkbox' style='width:70px;height:20px' unchecked class='ralf' value='ram'>";
         ...
         echo"<b id='red'> ".$a." is Wrong Search <b> ";
